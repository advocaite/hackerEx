                            ...
                            <tbody>
                                @foreach ($rankData as $i => $rank)
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('profile.show', ['id' => $rank->userID]) }}">{{ $rank->login }}</a>
                                            @if ($rank->online)
                                                <span class="r-online"></span>
                                                @endif @if ($rank->premium)
                                                    <span class="r-premium"></span>
                                                @endif
                                        </td>
                                        <td>
                                            <center>{{ $rank->exp }}</center>
                                        </td>
                                        <td>
                                            <center>{{ $rank->hackedDB }}</center>
                                        </td>
                                        <td>
                                            @if ($rank->clanID)
                                                <a href="clan?id={{ $rank->clanID }}">[{{ $rank->nick }}]
                                                    {{ $rank->name }}</a>
                                            @endif
                                        </td>
                                    </tr>
